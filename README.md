## Gmail inspired clone that allows for account creation and compose of "faux-email" and send back to account user. Using React-Redux, Node.js, Firestore database, and Firebase Authentication.
